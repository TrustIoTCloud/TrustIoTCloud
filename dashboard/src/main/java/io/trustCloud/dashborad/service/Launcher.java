...
public final class Launcher {
    ...
    public Server run() throws InterruptedException, IOException {
...
//        qQos(MqttQoS.AT_LEAST_ONCE);
        ...
        List<Subscription> list = mqttBroker.getSubscriptionsRepository().listAllSubscriptions();
        Collection<ClientDescriptor> clients = mqttBroker.getSessions().listConnectedClients();
