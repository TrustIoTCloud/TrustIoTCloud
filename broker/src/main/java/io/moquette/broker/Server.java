...
public class Server {
    ...
    public ISubscriptionsRepository getSubscriptionsRepository() {
        return subscriptionsRepository;
    }

    public void setSubscriptionsRepository(ISubscriptionsRepository subscriptionsRepository) {
    ...
    public void setQueueRepository(IQueueRepository queueRepository) {
        this.queueRepository = queueRepository;
    }

    public IRetainedRepository getRetainedRepository() {
        return retainedRepository;
    }

    public void setRetainedRepository(IRetainedRepository retainedRepository) {
